    ...
    <div class="nk-block-head nk-block-head-lg">
        <div class="nk-block-between-md g-4">
            <div class="nk-block-head-content">
                <h2 class="nk-block-title fw-normal">Welcome, <?= $admin['adm_name'] ?></h2>
                    ...
                    <div class="nk-wg1">
                        <div class="nk-wg1-block">
                            ...
                            <div class="nk-wg1-text">
                                <h5 class="title">Total Bookings</h5>
                ...
                <div class="card card-bordered card-full">
                    <div class="nk-wg1">
                        <div class="nk-wg1-block">
                            ...
                            <div class="nk-wg1-text">
                                <h5 class="title">Reject Booking</h5>
                                <h1><?= $bookingReject; ?></h1>                            </div>
                        </div>
                        <div class="nk-wg1-action">
                ...
                <div class="card card-bordered card-full">
                    <div class="nk-wg1">
                        <div class="nk-wg1-block">
                            ...
                            <div class="nk-wg1-text">
                                <h5 class="title">Accepted Booking</h5>
                                <h1><?= $bookingAccepted; ?></h1>                            </div>
                        </div>
                        <div class="nk-wg1-action">
                ...
                <div class="card card-bordered card-full">
                    <div class="nk-wg1">
                        <div class="nk-wg1-block">
                            ...
                            <div class="nk-wg1-text">
                                <h5 class="title">Total Listing</h5>
                                <h1><?= $totalListing; ?></h1>                            </div>
                        </div>
                        <div class="nk-wg1-action">
                            <!-- <a href="html/subscription/payments.html" class="link"><span>Payment History</span> <em class="icon ni ni-chevron-right"></em></a> -->
                        </div>
                ...
                <div class="card card-bordered card-full">
                    <div class="nk-wg1">
                        <div class="nk-wg1-block">
                            ...
                            <div class="nk-wg1-text">
                                <h5 class="title">Active Listing</h5>
                                <h1><?= $activeListing; ?></h1>                            </div>
                        </div>
                        <div class="nk-wg1-action">
                            <!-- <a href="html/subscription/subscriptions.html" class="link"><span>Manage Subscription</span> <em class="icon ni ni-chevron-right"></em></a> -->
                        </div>
