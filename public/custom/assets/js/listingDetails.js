...
function addGuests(totalGuests) {
    ...
    for (i = 0; i < totalGuests; i++) {
        ...
        var GENDERSELECT = getGenderSelect(i);
...
function getGenderSelect(i) {
    var SELECT01 = document.createElement('select');
    SELECT01.id = 'guestgender_' + i;
    SELECT01.setAttribute('name', "guest[" + i + "]['gender']");
