$(document).ready(function () {
  if (document.getElementById("map") !== null) {
    ...
    L.tileLayer(
      "https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}",
      {
        ...
        accessToken:
          "pk.eyJ1IjoiYWh0ZXNoYW0yMDAwIiwiYSI6ImNrbndoeGExNDB3cGcydXFudDAwaG13ejEifQ.jWAnv0IKMoWs2KsG7moRDA",
      }
    ).addTo(map);
    ...
    for (var i = 0; i < locations.length; i++) {
      ...
      var popupOptions = { maxWidth: "270", className: "leaflet-infoBox" };
      var markerArray = [];
  ...
  function singleListingMap() {
    ...
    marker = new L.marker([lat, lng], { icon: listeoIcon }).addTo(map_single);
    L.tileLayer(
      "https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}",
      {
        attribution:
